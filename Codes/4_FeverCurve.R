...
# Main chart of curve
ShortLines <- c("2020-03-16",  "2020-05-27", "2020-11-09", "2020-12-19", "2022-02-24")
ShortLabels <- c("Covid-19 lockdown", "Easing measures", "Successful vaccine study", "Tighter national restrictions", "Russian invasion of Ukraine")
p <- ts_ggplot(
